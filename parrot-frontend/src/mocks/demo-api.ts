...
const demoAiModels = [
  ...
  { id: "claude-3-7-sonnet-latest", label: "Anthropic - claude-3-7-sonnet-latest", provider: "frontend-demo", isDefault: false },
  { id: "claude-3-5-sonnet-latest", label: "Anthropic - claude-3-5-sonnet-latest", provider: "frontend-demo", isDefault: false },
  { id: "claude-3-5-haiku-latest", label: "Anthropic - claude-3-5-haiku-latest", provider: "frontend-demo", isDefault: false },
  { id: "gemini-3-pro-preview", label: "Google - gemini-3-pro-preview", provider: "frontend-demo", isDefault: false },
  { id: "gemini-3-flash-preview", label: "Google - gemini-3-flash-preview", provider: "frontend-demo", isDefault: false },
  { id: "gemini-2.5-pro", label: "Google - gemini-2.5-pro", provider: "frontend-demo", isDefault: false },
  { id: "gemini-2.5-flash", label: "Google - gemini-2.5-flash", provider: "frontend-demo", isDefault: false },
  { id: "gemini-2.5-flash-lite", label: "Google - gemini-2.5-flash-lite", provider: "frontend-demo", isDefault: false },
  { id: "grok-4.20-reasoning", label: "xAI - grok-4.20-reasoning", provider: "frontend-demo", isDefault: false },
  { id: "grok-4.20-non-reasoning", label: "xAI - grok-4.20-non-reasoning", provider: "frontend-demo", isDefault: false },
  { id: "grok-4-1-fast-reasoning", label: "xAI - grok-4-1-fast-reasoning", provider: "frontend-demo", isDefault: false },
  { id: "grok-4-1-fast-non-reasoning", label: "xAI - grok-4-1-fast-non-reasoning", provider: "frontend-demo", isDefault: false },
  ...
  { id: "qwen3-max", label: "Qwen - qwen3-max", provider: "frontend-demo", isDefault: false },
  { id: "qwen3-max-preview", label: "Qwen - qwen3-max-preview", provider: "frontend-demo", isDefault: false },
  { id: "qwen3.6-plus", label: "Qwen - qwen3.6-plus", provider: "frontend-demo", isDefault: false },
  { id: "qwen3.5-plus", label: "Qwen - qwen3.5-plus", provider: "frontend-demo", isDefault: false },
  { id: "qwen3.5-flash", label: "Qwen - qwen3.5-flash", provider: "frontend-demo", isDefault: false },
  { id: "qwen-max", label: "Qwen - qwen-max", provider: "frontend-demo", isDefault: false },
  { id: "qwen-max-latest", label: "Qwen - qwen-max-latest", provider: "frontend-demo", isDefault: false },
  { id: "qwen-plus", label: "Qwen - qwen-plus", provider: "frontend-demo", isDefault: false },
  { id: "qwen-plus-latest", label: "Qwen - qwen-plus-latest", provider: "frontend-demo", isDefault: false },
  { id: "qwen-flash", label: "Qwen - qwen-flash", provider: "frontend-demo", isDefault: false },
  { id: "qwen-turbo", label: "Qwen - qwen-turbo", provider: "frontend-demo", isDefault: false },
  { id: "qwen-turbo-latest", label: "Qwen - qwen-turbo-latest", provider: "frontend-demo", isDefault: false },
  { id: "glm-5.1", label: "Zhipu - glm-5.1", provider: "frontend-demo", isDefault: false },
  { id: "glm-5", label: "Zhipu - glm-5", provider: "frontend-demo", isDefault: false },
  { id: "glm-4.7", label: "Zhipu - glm-4.7", provider: "frontend-demo", isDefault: false },
  { id: "glm-4.6", label: "Zhipu - glm-4.6", provider: "frontend-demo", isDefault: false },
] as const;
